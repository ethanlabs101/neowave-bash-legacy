...
⚙️ How It Works
- 1. Run neowave from your terminal.
...
- 3. All changes generate a temporary config (tmp.conf) which can be previewed or applied.
- 4. Original NEOFETCH configs are backed up in stock_configs so you can revert safely.
